...
class _MoldListScreenState extends State<MoldListScreen> {
  ...
  final List<Mold> _allMolds = [
    ...
    Mold(inventoryNumber: '047-1', moldName: 'Ковш для бани', moldWeight: 0),
    Mold(inventoryNumber: '082-1', moldName: 'Ковш', moldWeight: 0),
    Mold(inventoryNumber: '014-1\n009-2', moldName: 'Решетка для мойки 270х270 (старая)', moldWeight: 0),
    Mold(inventoryNumber: '600-3\n601-2', moldName: 'Решетка для мойки 298х278 (новая)', moldWeight: 0),
    Mold(inventoryNumber: '593-1', moldName: 'Решетка для мойки о295', moldWeight: 0),
    Mold(inventoryNumber: '182-1', moldName: 'Полка угловая', moldWeight: 0),
    Mold(inventoryNumber: '827-1', moldName: 'Полка туалетная', moldWeight: 0),
    Mold(inventoryNumber: '870-1', moldName: 'Держатель к полке туалетной', moldWeight: 0),
    Mold(inventoryNumber: '436-1', moldName: 'Крючок держателя туалетной бумаги', moldWeight: 0),
    Mold(inventoryNumber: '435-1?', moldName: 'Крышка держателя туалетнй бумаги', moldWeight: 0),
    Mold(inventoryNumber: '437-1', moldName: 'Корпус держателя туалетнй бумаги', moldWeight: 0),
    Mold(inventoryNumber: '085-1', moldName: 'Основание подставки зубной щетки', moldWeight: 0),
    Mold(inventoryNumber: '086-1', moldName: 'Крышка подставки зубной щетки', moldWeight: 0),
    Mold(inventoryNumber: '482-3\n695-1\n970-4', moldName: 'Мыльница 110х70х50 (101x187)', moldWeight: 0),
    Mold(inventoryNumber: '228-1\n694-2', moldName: 'Мыльница 110x70x40 (101-216)', moldWeight: 0),
    Mold(inventoryNumber: '638-1', moldName: 'Мыльница 110x75x25', moldWeight: 0),
    Mold(inventoryNumber: '103-1', moldName: 'Основание решетки мыльницы', moldWeight: 0),
    Mold(inventoryNumber: '297-1', moldName: 'Мыльница бытовая под хозяйственное мыло', moldWeight: 0),
    Mold(inventoryNumber: '095-2\n277-1', moldName: 'Решетка мыльницы 101-115', moldWeight: 0),
    Mold(inventoryNumber: '063-1', moldName: 'Мыльница полочка угловая', moldWeight: 0),
    Mold(inventoryNumber: '062-1', moldName: 'Полочкеа к Мыльница полочка угловая', moldWeight: 0),
    Mold(inventoryNumber: '060-1', moldName: 'Крючок кронштейн к Мыльница полочка угловая', moldWeight: 0),
    Mold(inventoryNumber: '966-1\n989-3\n880-4', moldName: 'Подставка под календарь', moldWeight: 0),
    Mold(inventoryNumber: '500-1', moldName: 'Дужка для календаря', moldWeight: 0),
    Mold(inventoryNumber: '977-5', moldName: 'Вешалка 48-50', moldWeight: 0),
    Mold(inventoryNumber: '933-1\n162-1', moldName: 'Вешалка с крючклм без перекладины', moldWeight: 0),
    Mold(inventoryNumber: '621', moldName: 'Вешалка 52-54', moldWeight: 0),
    Mold(inventoryNumber: '107-1\n788-2', moldName: 'Крючок ми 101х182', moldWeight: 0),
    Mold(inventoryNumber: '059-2', moldName: 'Вешалка с крючком мет с перекладиной', moldWeight: 0),
    Mold(inventoryNumber: '320-1', moldName: 'Вешалка 5-ти рожковая', moldWeight: 0),
    Mold(inventoryNumber: '319-1', moldName: 'Заглушка для вешалки', moldWeight: 0),
    Mold(inventoryNumber: '761', moldName: 'Вешалка для юбок и брюк', moldWeight: 0),
    Mold(inventoryNumber: '762', moldName: 'Крючок для Вешалка для юбок и брюк', moldWeight: 0),
    Mold(inventoryNumber: '093', moldName: 'Рожок для обуви (большой)', moldWeight: 0),
    Mold(inventoryNumber: '098', moldName: 'Рожок для обуви (малый)', moldWeight: 0),
    Mold(inventoryNumber: '105', moldName: 'Рожок для обуви (500)', moldWeight: 0),
    Mold(inventoryNumber: '744-4', moldName: 'Совок для мусора (старый)', moldWeight: 0),
    Mold(inventoryNumber: '741-1\n759-2', moldName: 'Совок для мусора (зубчатый)', moldWeight: 0),
    Mold(inventoryNumber: '775-1', moldName: 'Совок для мусора (новый)', moldWeight: 0),
    Mold(inventoryNumber: '777-1', moldName: 'Ручка совка для мусора', moldWeight: 0),
    Mold(inventoryNumber: '015-1', moldName: 'Совок для сыпучих продуктов', moldWeight: 0),
    Mold(inventoryNumber: '866-1', moldName: 'Емкость для пищевых продуктов (2л?)', moldWeight: 0),
    Mold(inventoryNumber: '869-1', moldName: 'Крышка для Емкость для пищевых продуктов', moldWeight: 0),
    Mold(inventoryNumber: '164', moldName: 'Воронка для жидкостей', moldWeight: 0),
    Mold(inventoryNumber: '322-1', moldName: 'Лопатка для торта', moldWeight: 0),
    Mold(inventoryNumber: '441-1', moldName: 'Ситечко для банок', moldWeight: 0),
    Mold(inventoryNumber: '455-1', moldName: 'крышка для слива', moldWeight: 0),
    Mold(inventoryNumber: '641-1', moldName: 'Емкость для кормления животных', moldWeight: 0),
    Mold(inventoryNumber: '624-1', moldName: 'Емкость двойная для кормления животных', moldWeight: 0),
    Mold(inventoryNumber: '780-1', moldName: 'Лоток 230х150х60', moldWeight: 0),
    Mold(inventoryNumber: '779', moldName: 'Лоток 385х270х155', moldWeight: 0),
    Mold(inventoryNumber: '175-1', moldName: 'Лоток для бумаг', moldWeight: 0),
    Mold(inventoryNumber: '101-1', moldName: 'Грабли большие', moldWeight: 0),
    Mold(inventoryNumber: '102-1', moldName: 'Грабли садовые малые', moldWeight: 0),
    Mold(inventoryNumber: '070-1', moldName: 'Доска разделочная', moldWeight: 0),
    Mold(inventoryNumber: '064-1', moldName: 'Доска разделочная (с лоток)', moldWeight: 0),
    Mold(inventoryNumber: '652-1', moldName: 'Корпус подставки для сушки посуды', moldWeight: 0),
    Mold(inventoryNumber: '653-1', moldName: 'Поддон подставки для сушки посуды', moldWeight: 0),
    Mold(inventoryNumber: '538-1', moldName: 'Основание набор столовый', moldWeight: 0),
    Mold(inventoryNumber: '539-1', moldName: 'Ручка набор столовый', moldWeight: 0),
    Mold(inventoryNumber: '540-1', moldName: 'Обод горчичницы', moldWeight: 0),
    Mold(inventoryNumber: '541-1', moldName: 'Крышка горчичницы', moldWeight: 0),
    Mold(inventoryNumber: '542-1', moldName: 'Крышка солонки', moldWeight: 0),
    Mold(inventoryNumber: '543-1', moldName: 'Ложка горчичн', moldWeight: 0),
    Mold(inventoryNumber: '544-1', moldName: 'Корпус горчичницы', moldWeight: 0),
    Mold(inventoryNumber: '545-1', moldName: 'Салат для салфеток', moldWeight: 0),
    Mold(inventoryNumber: '949-1', moldName: 'Полка набора для специй', moldWeight: 0),
    Mold(inventoryNumber: '950-1', moldName: 'Корпус стакана для специй', moldWeight: 0),
    Mold(inventoryNumber: '379', moldName: 'Крышка для специй', moldWeight: 0),
    Mold(inventoryNumber: '894', moldName: 'Корпус стакана для специй?', moldWeight: 0),
    Mold(inventoryNumber: '306-1', moldName: 'Основание масленки', moldWeight: 0),
    Mold(inventoryNumber: '305-1', moldName: 'Крышка масленки', moldWeight: 0),
    Mold(inventoryNumber: '900-1', moldName: 'Этажерка угловая Стойка', moldWeight: 0),
    Mold(inventoryNumber: '901-1', moldName: 'Этажерка угловая Подставка', moldWeight: 0),
    Mold(inventoryNumber: '902-1', moldName: 'Этажерка угловая Опора', moldWeight: 0),
    Mold(inventoryNumber: '903-1', moldName: 'Этажерка угловая Заглушка', moldWeight: 0),
    Mold(inventoryNumber: '203-1', moldName: 'Полка для обуви - корпус', moldWeight: 0),
    Mold(inventoryNumber: '202-1', moldName: 'Полка для обуви - заглушка с крючком', moldWeight: 0),
    Mold(inventoryNumber: '526-1\n225-2', moldName: 'Дюбель 30', moldWeight: 0),
    Mold(inventoryNumber: '529-1\n530-2', moldName: 'Дюбель 40', moldWeight: 0),
    Mold(inventoryNumber: '518-1', moldName: 'Дюбель 60 (к унитазу)', moldWeight: 0),
    Mold(inventoryNumber: '546-1', moldName: 'Заглушка крепления унитаза', moldWeight: 0),
    Mold(inventoryNumber: '510-1', moldName: 'Корпус заглушки крепления унитаза', moldWeight: 0),
    Mold(inventoryNumber: '208-1\n211-2', moldName: 'Решетка вентиляционная Рамка (новая)', moldWeight: 0),
    Mold(inventoryNumber: '209-1\n217-2', moldName: 'Решетка вентиляционная ', moldWeight: 0),
    Mold(inventoryNumber: '201-1', moldName: 'Решетка вентиляционная 250x170', moldWeight: 0),
    Mold(inventoryNumber: '248-1', moldName: 'Решетка вентиляционная 265x265 (жал)', moldWeight: 0),
    Mold(inventoryNumber: '249-1', moldName: 'Решетка вентиляционная Рамка (265-265?)', moldWeight: 0),
    Mold(inventoryNumber: '251-1', moldName: 'Решетка вентиляционная Сетка (жал) (больш)', moldWeight: 0),
    Mold(inventoryNumber: '670-3', moldName: 'Прищепка', moldWeight: 0),
    Mold(inventoryNumber: '693-2', moldName: 'Прищепка ми101-185', moldWeight: 0),
    Mold(inventoryNumber: '124-2', moldName: 'Кнопка чехла ми 101-95', moldWeight: 0),
    Mold(inventoryNumber: '019-1\n018-4', moldName: 'Обод унитаза новый', moldWeight: 0),
    Mold(inventoryNumber: '055-1\n053-1', moldName: 'Крышка унитаза (нов)', moldWeight: 0),
    Mold(inventoryNumber: '048\n056', moldName: 'Винт унитаза (нов)', moldWeight: 0),
    Mold(inventoryNumber: '054-1\n017-1\n057-2', moldName: 'Петля левая правая (нов)', moldWeight: 0),
    Mold(inventoryNumber: '795-4', moldName: 'Гайка унитаза (нов)', moldWeight: 0),
    Mold(inventoryNumber: '029-1\n504-3\n602-2', moldName: 'Сиденье унитаза (старое)', moldWeight: 0),
    Mold(inventoryNumber: '030-1\n336-2\n517-3', moldName: 'Крышка сиденья унитаза (стар)', moldWeight: 0),
    Mold(inventoryNumber: '145-1\n377-2', moldName: 'Шайба сиденья унитаза (стар) ', moldWeight: 0),
    Mold(inventoryNumber: '076-1\n338-2', moldName: 'Винт/спец сиденья унитаза (стар) ', moldWeight: 0),
    Mold(inventoryNumber: '793-2\n794-3', moldName: 'Гайка сиденья унитаза (стар) ', moldWeight: 0),
    Mold(inventoryNumber: '146-1\n147-2', moldName: 'Опора сиденья унитаза (стар) ', moldWeight: 0),
    Mold(inventoryNumber: '332-2', moldName: 'Сиденья унитаза детское', moldWeight: 0),
    Mold(inventoryNumber: '393-3', moldName: 'Сиденья унитаза детское', moldWeight: 0),
    Mold(inventoryNumber: '394-1', moldName: 'Сиденья унитаза детское (для мальчиков)', moldWeight: 0),
    Mold(inventoryNumber: '769-1', moldName: 'Секция ограждения для клумбы', moldWeight: 0),
    Mold(inventoryNumber: '921', moldName: 'Ящик для рассады', moldWeight: 0),
    Mold(inventoryNumber: '929-1', moldName: 'Санки-ледянки', moldWeight: 0),
    Mold(inventoryNumber: '430', moldName: 'Лопата для снега', moldWeight: 0),
    Mold(inventoryNumber: '112', moldName: 'Грабли веерные', moldWeight: 0),
